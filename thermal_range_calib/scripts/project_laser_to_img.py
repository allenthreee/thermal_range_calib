...
pcd = o3d.io.read_point_cloud("/home/allen/calib_data/cjy_single_scene_calibration/0.pcd")
...
image = cv2.imread("/home/allen/calib_data/cjy_single_scene_calibration/0.png")
