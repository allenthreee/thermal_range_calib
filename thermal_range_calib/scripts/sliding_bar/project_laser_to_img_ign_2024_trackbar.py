...
def load_point_cloud(filename):
    ...
    # Downsample the point cloud by selecting every second point
    # downsampled_pcd_arr = pcd_arr[::2]
    return pcd_arr

# Define the camera matrix
fx = 550.987563588087
fy = 553.613209287033897
cx = 320
cy = 240
...
pcd_arr = load_point_cloud("/home/allen/calib_data/2024_aug/2024_aug_ign_downsample.pcd")
print(pcd_arr.shape)
# Load the image
image = cv2.imread("/home/allen/calib_data/2024_aug/2024-aug-640x480.png")
...
def update_params(x):
    ...
    for i in range(len(pcd_arr)):
        ...
        resized_image = cv2.circle(resized_image, (int(points_2d[i][0][0]), int(points_2d[i][0][1])), radius=0, color=(R, G, B), thickness=2)
